...
Spinner spinnerMain,spinnerDropDown;
   ArrayAdapter spinnerAdapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //CheckBox checkbox=(CheckBox)findViewById( R.id.checkbox_done );
        rv = (RecyclerView) findViewById(R.id.recyclerView);
        rv.setLayoutManager(new LinearLayoutManager(this));

        //spinner variable is used to call the spinner I used on main page
        spinnerMain = (Spinner) findViewById(R.id.todo_spinner_main);
    ...
    //onItemSelected is created by the interface AdapterView.OnItemSelectedListener
    @Override
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {

    }
    //onNothingSelected is created by the interface AdapterView.OnItemSelectedListener
